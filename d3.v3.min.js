d3 = function() {
    ...
    function A(n) {
        return arguments.length || (n = vo.ascending),
        function(t, e) {
    ...
    function j() {
        var n = ".dragsuppress-" + ++Zo
          , t = "touchmove" + n
          , e = "selectstart" + n
          , r = "dragstart" + n
          , u = "click" + n
          , i = vo.select(bo).on(t, f).on(e, f).on(r, f)
          , o = xo.style
          , a = o[Vo];
        return o[Vo] = "none",
        function(t) {
    ...
    function W(n, t, e) {
        return isNaN(n) && (n = 0),
        isNaN(t) && (t = 0),
        J(e, Math.cos(n *= Jo) * t, Math.sin(n) * t)
    }
    function J(n, t, e) {
        return new G(n,t,e)
    }
    ...
    function K(n, t, e) {
        ...
        r = nt(r) * ca,
        i = nt(i) * la,
        it(et(3.2404542 * u - 1.5371385 * r - .4985314 * i), et(-.969266 * u + 1.8760108 * r + .041556 * i), et(.0556434 * u - .2040259 * r + 1.0572252 * i))
    }
    function Q(n, t, e) {
    ...
    function ct(n, t, e) {
        ...
        return (i = ha.get(n)) ? t(i.r, i.g, i.b) : (null != n && "#" === n.charAt(0) && (4 === n.length ? (o = n.charAt(1),
        o += o,
        a = n.charAt(2),
        a += a,
        c = n.charAt(3),
    ...
    function st(n, t, e) {
        ...
        t = ft(t),
        e = ft(e);
        var r = tt((.4124564 * n + .3575761 * t + .1804375 * e) / aa)
          , u = tt((.2126729 * n + .7151522 * t + .072175 * e) / ca)
          , i = tt((.0193339 * n + .119192 * t + .9503041 * e) / la);
    ...
    function vt(n, t, e, r) {
        ...
        var i = {}
          ...
          , l = null;
        return !bo.XDomainRequest || "withCredentials"in c || !/^(http(s)?:)?\/\//.test(n) || (c = new XDomainRequest),
    ...
    function yt() {
        var n = xt()
          , t = bt() - n;
        t > 24 ? (isFinite(t) && (clearTimeout(va),
        va = setTimeout(yt, t)),
        da = 0) : (da = 1,
        ya(yt))
    }
    ...
    function xt() {
        var n = Date.now();
        for (ma = ga; ma; )
            n >= ma.time && (ma.flush = ma.callback(n - ma.time)),
            ma = ma.next;
        return n
    }
    function bt() {
        for (var n, t = ga, e = 1 / 0; t; )
            t.flush ? t = n ? n.next = t.next : ga = t.next : (t.time < e && (e = t.time),
            t = (n = t).next);
        return pa = n,
        e
    }
        ...
        return function(u) {
            ...
            var h, g, p, d = t(u), v = {
                ...
                polygonEnd: function() {
                    ...
                    v.lineEnd = c,
                    h = vo.merge(h),
                    h.length ? Zt(h, Jt, null, e, u) : r(g) && (u.lineStart(),
                    e(null, null, 1, u),
                    u.lineEnd()),
                    u.polygonEnd(),
                    h = g = null
            ...
            if (h) {
                for (var g = f[0], p = g[0], d = g[1] / 2 + Bo / 4, v = Math.sin(d), m = Math.cos(d), y = 1; ; ) {
                    ...
                    var M = n[0]
                      ...
                      , S = Math.abs(w) > Bo
                      , E = v * b;
                    if (Ca.add(Math.atan2(E * Math.sin(w), m * _ + E * Math.cos(w))),
                    Math.abs(x) < $o && (a = !0),
                    i += S ? w + (w >= 0 ? 2 : -2) * Bo : w,
                    S ^ p >= e ^ M >= e) {
                        var k = Dt(zt(g), zt(n));
    ...
    function Kt(n) {
        ...
        return {
            ...
            point: function(i, o) {
                var a = i > 0 ? Bo : -Bo
                  , c = Math.abs(i - e);
                Math.abs(c - Bo) < $o ? (n.point(e, r = (r + o) / 2 > 0 ? Bo / 2 : -Bo / 2),
                n.point(u, r),
                n.lineEnd(),
                n.lineStart(),
                n.point(a, r),
                n.point(i, r),
                t = 0) : u !== a && c >= Bo && (Math.abs(e - u) < $o && (e -= u * $o),
                Math.abs(i - a) < $o && (i -= a * $o),
                r = Qt(e, r, i, o),
                n.point(u, r),
                n.lineEnd(),
                n.lineStart(),
    ...
    function ee(n) {
        ...
        function r(n, t, e) {
            ...
            if (!(0 > M)) {
                ...
                E = k,
                k = _),
                q ? N ? E + k > 0 ^ b[1] < (Math.abs(b[0] - w) < $o ? E : k) : E <= b[1] && b[1] <= k : A > Bo ^ (w <= b[0] && b[0] <= S)) {
                    var T = Lt(v, (-m + x) / y);
                    return jt(T, p),
                    [b, Ft(T)]
                }
    ...
    function re(n, t, e, r) {
        ...
        function a(u, i) {
            var o = i[0] - u[0]
              , a = i[1] - u[1]
              , c = [0, 1];
            return Math.abs(o) < $o && Math.abs(a) < $o ? n <= u[0] && u[0] <= e && t <= u[1] && u[1] <= r : ue(n - u[0], o, c) && ue(u[0] - e, -o, c) && ue(t - u[1], a, c) && ue(u[1] - r, -a, c) ? (c[1] < 1 && (i[0] = u[0] + c[1] * o,
            i[1] = u[1] + c[1] * a),
            c[0] > 0 && (u[0] += c[0] * o,
            u[1] += c[0] * a),
            !0) : !1
        ...
        return function(c) {
            ...
            function s(n) {
                for (var t = 0, e = M.length, r = n[1], u = 0; e > u; ++u)
                    for (var i, o = 1, a = M[u], c = a.length, l = a[0]; c > o; ++o)
                        i = a[o],
                        l[1] <= r ? i[1] > r && f(l, i, n) > 0 && ++t : i[1] <= r && f(l, i, n) < 0 && --t,
                        l = i;
                return 0 !== t
            }
            function f(n, t, e) {
            ...
            var y, M, x, b, _, w, S, E, k, A, N = c, q = Wt(), T = {
                point: p,
                lineStart: d,
                lineEnd: v,
                polygonStart: function() {
                ...
                polygonEnd: function() {
                    c = N,
                    (y = vo.merge(y)).length ? (c.polygonStart(),
                    Zt(y, i, l, h, c),
                    c.polygonEnd()) : s([n, t]) && (c.polygonStart(),
                    c.lineStart(),
                    h(null, null, 1, c),
                    c.lineEnd(),
                    c.polygonEnd()),
        ...
        function e(t, i, o, a, c, l, s, f, h, g, p, d, v, m) {
            ...
            if (x > 4 * r && v--) {
                var b = a + g
                  ...
                  , E = Math.asin(w /= S)
                  , k = Math.abs(Math.abs(w) - 1) < $o ? (o + h) / 2 : Math.atan2(_, b)
                  , A = n(k, E)
                  , N = A[0]
                  , q = A[1]
                  , T = N - t
                  , z = q - i
                  , C = M * T - y * z;
                (C * C / x > r || Math.abs((y * T + M * z) / x - .5) > .3 || u > a * g + c * p + l * d) && (e(t, i, o, a, c, l, N, q, k, b /= S, _ /= S, w, v, m),
                m.point(N, q),
                e(N, q, k, b, _, w, s, f, h, g, p, d, v, m))
            }
        }
        var r = .5
          , u = Math.cos(30 * Jo)
    ...
    function be(n) {
        ...
        t.clipExtent = function(n) {
            ...
            b = n ? re(n[0][0], n[0][1], n[1][0], n[1][1]) : pt,
            u()) : w
        }
        ,
        t.scale = function(n) {
        ...
        ,
        t.center = function(n) {
            return arguments.length ? (d = n[0] % 360 * Jo,
            v = n[1] % 360 * Jo,
            r()) : [d * Go, v * Go]
        }
        ,
        t.rotate = function(n) {
            return arguments.length ? (m = n[0] % 360 * Jo,
            y = n[1] % 360 * Jo,
            M = n.length > 2 ? n[2] % 360 * Jo : 0,
            r()) : [m * Go, y * Go, M * Go]
        }
        ,
    ...
    function Ne(n, t) {
        ...
        return function(u, i, o, a) {
            ...
            null != u ? (u = qe(e, u),
            i = qe(e, i),
            (o > 0 ? i > u : u > i) && (u += 2 * o * Bo)) : (u = n + 2 * o * Bo,
            i = n - .5 * c);
            for (var l, s = u; o > 0 ? s > i : i > s; s -= c)
                a.point((l = Ft([e, -r * Math.cos(s), -r * Math.sin(s)]))[0], l[1])
        }
    }
    function qe(n, t) {
        var e = zt(t);
    ...
    function Ie(n) {
        ...
        t.interpolate = function(n) {
            return arguments.length ? (o = "function" == typeof n ? i = n : (i = fc.get(n) || Ze).key,
            t) : o
        }
        ,
    ...
    function Ge(n, t) {
        return n.length < 3 ? Ze(n) : n[0] + Qe((n.push(n[0]),
        n), nr([n[n.length - 2]].concat(n, [n[1]]), t))
    }
    function Ke(n, t) {
    ...
    function lr(n) {
        for (var t, e, r, u, i = [], o = cr(n), a = -1, c = n.length - 1; ++a < c; )
            t = ar(n[a], n[a + 1]),
            Math.abs(t) < 1e-6 ? o[a] = o[a + 1] = 0 : (e = o[a] / t,
            r = o[a + 1] / t,
            u = e * e + r * r,
    ...
    function Hr(n, t) {
        ...
        arguments.length ? e = t / (2 * Bo) * Math.asin(1 / n) : (n = 1,
        e = t / 4),
        function(r) {
    ...
    function Ur(n) {
        ...
        r *= -1,
        u *= -1),
        this.rotate = (r ? Math.atan2(t[1], t[0]) : Math.atan2(-e[0], e[1])) * Go,
        this.translate = [n.e, n.f],
        this.scale = [r, i],
        this.skew = i ? Math.atan2(u, i) * Go : 0
    }
    function Vr(n, t) {
    ...
    function uu(n, t) {
        return vo.rebind(n, t, "sort", "children", "value"),
        n.nodes = n,
        n.links = cu,
        n
    }
        ...
        if ((e = n.children) && (l = e.length)) {
            ...
            l > 2))
                ...
                o = 3; l > o; o++) {
                    ...
                    if (1 == p)
                        for (c = r._pack_prev; c !== a._pack_prev && !ju(c, i); c = c._pack_prev,
                        v++)
                            ;
                    p ? (v > d || d == v && u.r < r.r ? Du(r, u = a) : Du(r = c, u),
                    o--) : (Cu(r, i),
                    u = i,
                    t(i))
                }
    ...
    function Ku(n, t, e, r) {
        function u() {
            var u = Math.min(n.length, t.length) > 2 ? Gu : $u
              , c = r ? Wr : $r;
            return o = u(n, t, c, e),
            a = u(t, n, c, Sr),
            i
    ...
    function ii(n, t, e) {
        ...
        r.exponent = function(o) {
            return arguments.length ? (u = oi(t = o),
            i = oi(1 / t),
            n.domain(e.map(u)),
            r) : t
        }
    ...
    function mi(n) {
        ...
        ,
        t.interpolate = function(n) {
            return arguments.length ? (c = "function" == typeof n ? a = n : (a = fc.get(n) || Ze).key,
            l = a.reverse || a,
            s = a.closed ? "M" : "L",
            t) : c
        }
    ...
    function Ci(n, t, e) {
        ...
        function u(e) {
            return t(e = n(new $c(e - 1)), 1),
            e
        }
        function i(n, e) {
            return t(n = new $c(+n), e),
            n
        }
        function o(n, r, i) {
            var o = u(n)
    ...
    function ji(n) {
        function t(t) {
            for (var r, u, i, o = [], a = -1, c = 0; ++a < e; )
                ...
                null != (u = gl[r = n.charAt(++a)]) && (r = n.charAt(++a)),
                (i = pl[r]) && (r = i(t, null == u ? "e" === r ? " " : "0" : u)),
                o.push(r),
                c = a + 1);
        ...
        return t.parse = function(t) {
            ...
            var u = new $c;
            return "j"in e ? u.setFullYear(e.y, 0, e.j) : "w"in e && ("W"in e || "U"in e) ? (u.setFullYear(e.y, 0, 1),
            u.setFullYear(e.y, 0, "W"in e ? (e.w + 6) % 7 + 7 * e.W - (u.getDay() + 5) % 7 : e.w + 7 * e.U - (u.getDay() + 6) % 7)) : u.setFullYear(e.y, e.m, e.d),
    ...
    function Ri(n, t, e) {
        ...
        return r ? (n.w = il.get(r[0].toLowerCase()),
        e + r[0].length) : -1
    }
    function Yi(n, t, e) {
        vl.lastIndex = 0;
    ...
    function Zi(n, t, e) {
        ...
        return r ? (n.m = ll.get(r[0].toLowerCase()),
        e + r[0].length) : -1
    }
    function Xi(n, t, e) {
    ...
    try {
        ...
        var So = bo.Element.prototype
          , Eo = So.setAttribute
          , ko = So.setAttributeNS
          , Ao = bo.CSSStyleDeclaration.prototype
          , No = Ao.setProperty;
    ...
    vo.median = function(t, e) {
        ...
        t = t.filter(n),
        t.length ? vo.quantile(t.sort(vo.ascending), .5) : void 0
    }
    ,
    ...
    vo.bisectLeft = qo.left,
    vo.bisect = vo.bisectRight = qo.right,
    ...
    ,
    vo.event = null,
    vo.requote = function(n) {
        return n.replace(Do, "\\$&")
    }
    ;
    var Do = /[\\\^\$\*\+\?\|\[\]\(\)\.\{\}]/g
      , jo = {}.__proto__ ? function(n, t) {
        n.__proto__ = t
    }
    : function(n, t) {
        for (var e in t)
    ...
    Oo.selectAll = function(n) {
        ...
        for (var u = -1, i = this.length; ++u < i; )
            for (var o = this[u], a = -1, c = o.length; ++a < c; )
                (e = o[a]) && (r.push(t = yo(n.call(e, e.__data__, a, u))),
                t.parentNode = e);
        return p(r)
    }
    ;
    ...
    ;
    var Yo = [];
    vo.selection.enter = q,
    vo.selection.enter.prototype = Yo,
    Yo.append = Oo.append,
    Yo.empty = Oo.empty,
    Yo.node = Oo.node,
    Yo.call = Oo.call,
    Yo.size = Oo.size,
    Yo.select = function(n) {
    ...
    vo.behavior.drag = function() {
        ...
        var u = g(n, "drag", "dragstart", "dragend")
          , i = null
          , o = r(c, vo.mouse, "mousemove", "mouseup")
    ...
    vo.interpolateZoom = function(n, t) {
        ...
        var r = n[0]
          ...
          , f = l * l + s * s
          , h = Math.sqrt(f)
          , g = (c * c - i * i + na * f) / (2 * i * Qo * h)
          , p = (c * c - i * i - na * f) / (2 * c * Qo * h)
    ...
    vo.behavior.zoom = function() {
        ...
        function l() {
            ...
            function e() {
                f.on(N, bo === r ? p : null).on(q, null),
                g(s && vo.event.target === l),
                c(i)
            }
            var r = this
              , i = D.of(r, arguments)
        ...
        function s() {
            ...
            function h() {
                vo.event.touches.length ? n() : (y.on(z, null).on(C, null),
                x.on(A, l).on(T, s),
                b(),
                c(v))
            }
        ...
        function d() {
            ...
            o(n),
            r(Math.pow(2, vo.event.shiftKey ? Math.ceil(l) - 1 : Math.floor(l) + 1)),
            u(e, i),
            a(n),
            c(n)
        }
        var v, m, y, M, x, b, _, w, S = {
            ...
            y: 0,
            k: 1
        }, E = [960, 500], k = ea, A = "mousedown.zoom", N = "mousemove.zoom", q = "mouseup.zoom", T = "touchstart.zoom", z = "touchmove.zoom", C = "touchend.zoom", D = g(n, "zoomstart", "zoom", "zoomend");
        ...
        n.scaleExtent = function(t) {
            return arguments.length ? (k = null == t ? ea : [+t[0], +t[1]],
            n) : k
        }
        ,
        n.center = function(t) {
    ...
    fa.brighter = function(n) {
        ...
        e && u > e && (e = u),
        r && u > r && (r = u),
        it(Math.min(255, ~~(t / n)), Math.min(255, ~~(e / n)), Math.min(255, ~~(r / n)))) : it(u, u, u)
    }
    ,
    fa.darker = function(n) {
        return n = Math.pow(.7, arguments.length ? n : 1),
        it(~~(n * this.r), ~~(n * this.g), ~~(n * this.b))
    }
    ,
    fa.hsl = function() {
    ...
    ,
    vo.csv = vo.dsv(",", "text/csv"),
    vo.tsv = vo.dsv("	", "text/tab-separated-values");
    ...
    var Ma = "."
      ...
      , ba = [3, 3]
      , _a = "$"
      , wa = ["y", "z", "a", "f", "p", "n", "\xb5", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"].map(_t);
    vo.formatPrefix = function(n, t) {
        var e = 0;
        return n && (0 > n && (n *= -1),
        t && (n = vo.round(n, wt(n, t))),
    ...
    Et.prototype = {
        ...
        add: function(n) {
            kt(n, this.t, Na),
            kt(Na.s, this.s, this),
            this.s ? this.t += Na.t : this.s = Na.t
        },
        reset: function() {
            this.s = this.t = 0
        },
    ...
    var za, Ca = new Et, Da = {
        ...
        polygonEnd: function() {
            var n = 2 * Ca;
            za += 0 > n ? 4 * Bo + n : n,
            Da.lineStart = Da.lineEnd = Da.point = c
        }
    };
    ...
    vo.geo.centroid = function(n) {
        ja = La = Ha = Fa = Pa = Oa = Ra = Ya = Ia = Ua = Va = 0,
        vo.geo.stream(n, Za);
        var t = Ia
          , e = Ua
          , r = Va
        ...
        r = Pa),
        u = t * t + e * e + r * r,
        Wo > u) ? [0 / 0, 0 / 0] : [Math.atan2(e, t) * Go, P(r / Math.sqrt(u)) * Go]
    }
    ;
    var ja, La, Ha, Fa, Pa, Oa, Ra, Ya, Ia, Ua, Va, Za = {
        sphere: c,
        point: Ot,
        lineStart: Yt,
        lineEnd: It,
    ...
    vo.geo.albersUsa = function() {
        ...
        var t, e, r, u, i = vo.geo.albers(), o = vo.geo.conicEqualArea().rotate([154, 0]).center([-2, 58.5]).parallels([55, 65]), a = vo.geo.conicEqualArea().rotate([157, 0]).center([-3, 19.9]).parallels([8, 18]), c = {
            point: function(n, e) {
                t = [n, e]
            }
        };
        ...
        n.translate = function(t) {
            ...
            r = o.translate([s - .307 * l, f + .201 * l]).clipExtent([[s - .425 * l + $o, f + .12 * l + $o], [s - .214 * l - $o, f + .234 * l - $o]]).stream(c).point,
            u = a.translate([s - .205 * l, f + .212 * l]).clipExtent([[s - .214 * l + $o, f + .166 * l + $o], [s - .115 * l - $o, f + .234 * l - $o]]).stream(c).point,
            n
        }
        ,
        n.scale(1070)
    ...
    var Wa, Ja, Ga, Ka, Qa, nc, tc = {
        ...
        polygonEnd: function() {
            tc.lineStart = tc.lineEnd = tc.point = c,
            Wa += Math.abs(Ja / 2)
        }
    }, ec = {
        point: le,
    ...
    vo.geo.path = function() {
        ...
        return n.area = function(n) {
            return Wa = 0,
            vo.geo.stream(n, u(tc)),
            Wa
        }
        ,
        n.centroid = function(n) {
            return Ha = Fa = Pa = Oa = Ra = Ya = Ia = Ua = Va = 0,
            vo.geo.stream(n, u(rc)),
            Va ? [Ia / Va, Ua / Va] : Ya ? [Oa / Ya, Ra / Ya] : Pa ? [Ha / Pa, Fa / Pa] : [0 / 0, 0 / 0]
        }
        ,
        n.bounds = function(n) {
            return Qa = nc = -(Ga = Ka = 1 / 0),
            vo.geo.stream(n, u(ec)),
            [[Ga, Ka], [Qa, nc]]
        }
        ,
        n.projection = function(n) {
            return arguments.length ? (u = (e = n) ? n.stream || Me(n) : pt,
            t()) : e
        }
        ,
    ...
    ,
    vo.geo.projection = xe,
    vo.geo.projectionMutator = be,
    (vo.geo.equirectangular = function() {
        return xe(we)
    }
    ).raw = we.invert = we,
    vo.geo.rotation = function(n) {
        function t(t) {
            return t = n(t[0] * Jo, t[1] * Jo),
            t[0] *= Go,
            t[1] *= Go,
            t
        }
        return n = Se(n[0] % 360 * Jo, n[1] * Jo, n.length > 2 ? n[2] * Jo : 0),
        t.invert = function(t) {
            return t = n.invert(t[0] * Jo, t[1] * Jo),
            t[0] *= Go,
            t[1] *= Go,
            t
        }
    ...
    vo.geo.circle = function() {
        ...
        ,
        n.angle = function(r) {
            return arguments.length ? (e = Ne((t = +r) * Jo, u * Jo),
            n) : t
        }
        ,
        n.precision = function(r) {
            return arguments.length ? (e = Ne(t * Jo, (u = +r) * Jo),
            n) : u
        }
        ,
        n.angle(90)
    ...
    (vo.geo.conicConformal = function() {
        return oe(Fe)
    }
    ).raw = Fe,
    (vo.geo.conicEquidistant = function() {
        return oe(Pe)
    }
    ).raw = Pe;
    ...
    dc.clip = function(n) {
        for (var t, e, r, u, i, o, a = pr(n), c = -1, l = this.length - pr(this), s = this[l - 1]; ++c < l; ) {
            ...
            e = -1; ++e < r; )
                o = t[e],
                hr(o, s, u) ? (hr(i, s, u) || n.push(gr(i, o, s, u)),
                n.push(o)) : hr(i, s, u) && n.push(gr(i, o, s, u)),
                i = o;
            a && n.push(n[0]),
            s = u
        }
                ...
                if (!(r > 2)) {
                    ...
                    if (Math.abs(d) < $o) {
                        ...
                        var v = (l - a) * (g - s) > (h - l) * (s - c) ? f : -f
                          , y = Math.abs(d) - p;
                        Math.abs(y) < $o ? n.push([0 > d ? v : -v, v]) : (y > 0 && (v *= -1),
                        n.push([-f, v], [f, v]))
                    }
                }
            }),
    ...
    vo.geom.quadtree = function(n, t, e, r, u) {
        ...
        var o, a = Ue, c = Ve;
        return (o = arguments.length) ? (a = vr,
        c = mr,
        3 === o && (u = e,
        r = t,
        e = t = 0),
    ...
    ,
    vo.interpolateRgb = xr,
    vo.interpolateObject = br,
    vo.interpolateNumber = _r,
    vo.interpolateString = wr;
    var mc = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g;
    vo.interpolate = Sr,
    vo.interpolators = [function(n, t) {
        var e = typeof t;
    ...
    vo.ease = function(n) {
        ...
        return e = Mc.get(e) || yc,
        r = xc.get(r) || pt,
        kr(r(e.apply(null, Array.prototype.slice.call(arguments, 1))))
    }
    ,
    vo.interpolateHcl = Or,
    vo.interpolateHsl = Rr,
    vo.interpolateLab = Yr,
    vo.interpolateRound = Ir,
    vo.transform = function(n) {
    ...
    vo.interpolateTransform = Br,
    vo.layout = {},
    vo.layout.bundle = function() {
        return function(n) {
    ...
    vo.layout.force = function() {
        ...
        return a.tick = function() {
            ...
            y))
                for (; ++e < b; )
                    ...
                    a.y += (x - a.y) * y;
            if (g)
                for (ru(t = vo.geom.quadtree(v), r, o),
                e = -1; ++e < b; )
        ...
        ,
        a.drag = function() {
            return e || (e = vo.behavior.drag().origin(pt).on("dragstart.force", Qr).on("drag.force", t).on("dragend.force", nu)),
            arguments.length ? (this.on("mouseover.force", tu).on("mouseout.force", eu).call(e),
            void 0) : e
        }
        ,
        vo.rebind(a, c, "on")
    ...
    vo.layout.stack = function() {
        ...
        ,
        n.order = function(t) {
            return arguments.length ? (e = "function" == typeof t ? t : Ec.get(t) || hu,
            n) : e
        }
        ,
        n.offset = function(t) {
            return arguments.length ? (r = "function" == typeof t ? t : kc.get(t) || gu,
            n) : r
        }
        ,
        n.x = function(t) {
    ...
    vo.layout.histogram = function() {
        function n(n, i) {
            ...
            if (g > 0)
                for (i = -1; ++i < h; )
                    a = l[i],
                    a >= s[0] && a <= s[1] && (o = c[vo.bisect(f, a, 1, g) - 1],
                    o.y += p,
                    o.push(n[i]));
            return c
        }
        ...
        ,
        n.range = function(t) {
            return arguments.length ? (r = gt(t),
            n) : r
        }
        ,
        n.bins = function(t) {
    ...
    vo.layout.tree = function() {
        function n(n, i) {
            ...
            function c(n, t, r) {
                if (t) {
                    for (var u, i = n, o = n, a = t, c = n.parent.children[0], l = i._tree.mod, s = o._tree.mod, f = a._tree.mod, h = c._tree.mod; a = _u(a),
                    i = bu(i),
                    a && i; )
                        c = bu(c),
                        o = _u(o),
                        ...
                        h += c._tree.mod,
                        s += o._tree.mod;
                    a && !_u(o) && (o._tree.thread = a,
                    o._tree.mod += f - s),
                    i && !bu(c) && (c._tree.thread = i,
                    c._tree.mod += l - h,
                    r = n)
                }
                return r
    ...
    vo.layout.pack = function() {
        function n(n, i) {
            ...
            return Pu(a, c / 2, l / 2, t ? 1 : 1 / Math.max(2 * a.r / c, 2 * a.r / l)),
            o
        }
    ...
    ;
    var Tc = [2062260, 16744206, 2924588, 14034728, 9725885, 9197131, 14907330, 8355711, 12369186, 1556175].map(ut)
      , zc = [2062260, 11454440, 16744206, 16759672, 2924588, 10018698, 14034728, 16750742, 9725885, 12955861, 9197131, 12885140, 14907330, 16234194, 8355711, 13092807, 12369186, 14408589, 1556175, 10410725].map(ut)
      ...
      , Dc = [3244733, 7057110, 10406625, 13032431, 15095053, 16616764, 16625259, 16634018, 3253076, 7652470, 10607003, 13101504, 7695281, 10394312, 12369372, 14342891, 6513507, 9868950, 12434877, 14277081].map(ut);
    ...
    vo.svg.arc = function() {
        function n() {
            var n = t.apply(this, arguments)
              ...
              , o = r.apply(this, arguments) + jc
              , a = u.apply(this, arguments) + jc
              , c = (o > a && (c = o,
            o = a,
            a = c),
            a - o)
        ...
        return n.innerRadius = function(e) {
            return arguments.length ? (t = gt(e),
            n) : t
        }
        ,
        n.outerRadius = function(t) {
            return arguments.length ? (e = gt(t),
            n) : e
        }
        ,
        n.startAngle = function(t) {
        ...
        ,
        n.endAngle = function(t) {
            return arguments.length ? (u = gt(t),
            n) : u
        }
        ,
        n.centroid = function() {
            var n = (t.apply(this, arguments) + e.apply(this, arguments)) / 2
              , i = (r.apply(this, arguments) + u.apply(this, arguments)) / 2 + jc;
    ...
    vo.svg.chord = function() {
        ...
        return n.radius = function(t) {
            return arguments.length ? (a = gt(t),
            n) : a
        }
        ,
        n.source = function(t) {
            return arguments.length ? (i = gt(t),
            n) : i
        }
        ,
        n.target = function(t) {
            return arguments.length ? (o = gt(t),
            n) : o
        }
        ,
        n.startAngle = function(t) {
            return arguments.length ? (c = gt(t),
            n) : c
        }
        ,
        n.endAngle = function(t) {
            return arguments.length ? (l = gt(t),
            n) : l
        }
        ,
        n
    ...
    ,
    vo.transition.prototype = Yc,
    Oo.transition = function() {
        for (var n, t, e = Fc || ++Ic, r = [], u = Pc || {
            time: Date.now(),
            ease: zr,
            delay: 0,
            duration: 250
    ...
    Yc.ease = function(n) {
        var t = this.id;
        return arguments.length < 1 ? this.node().__transition__[t].ease : ("function" != typeof n && (n = vo.ease.apply(vo, arguments)),
        N(this, function(e) {
    ...
    vo.svg.axis = function() {
        function n(n) {
            n.each(function() {
                ...
                vo.transition(m)), M = e.copy(), x = this.__chart__ || M;
                this.__chart__ = M,
                g.append("line"),
                g.append("text");
                var b = g.select("line")
        ...
        ,
        n.orient = function(t) {
            return arguments.length ? (r = t in Vc ? t + "" : Uc,
            n) : r
        }
        ,
        n.ticks = function() {
    ...
    vo.svg.brush = function() {
        ...
        function u() {
            ...
            function v() {
                32 == vo.event.keyCode && 2 == q && (z[0] += s[1],
                z[1] += h[1],
                q = 0,
                f())
            }
            function m() {
                ...
                b && (n[0] += b[0],
                n[1] += b[1]),
                q || (vo.event.altKey ? (x || (x = [(s[0] + s[1]) / 2, (h[0] + h[1]) / 2]),
                z[0] = s[+(n[0] < x[0])],
                z[1] = h[+(n[1] < x[1])]) : x = null),
                A && y(n, c, 0) && (e(E),
                i = !0),
                N && y(n, l, 1) && (r(E),
                i = !0),
            ...
            function y(n, t, e) {
                ...
                q ? u = (r += f) + v : (x && (f = Math.max(c, Math.min(l, 2 * x[e] - r))),
                r > f ? (u = r,
                r = f) : u = f),
            ...
            function M() {
                m(),
                E.style("pointer-events", "all").selectAll(".resize").style("display", n.empty() ? "none" : null),
                vo.select("body").style("cursor", null),
            ...
            if (vo.event.changedTouches ? C.on("touchmove.brush", m).on("touchend.brush", M) : C.on("mousemove.brush", m).on("mouseup.brush", M),
        ...
        return n.event = function(n) {
            n.each(function() {
                var n = a.of(this, arguments)
                  ...
                  , e = this.__chart__ || t;
                this.__chart__ = t,
                Fc ? vo.select(this).transition().each("start.brush", function() {
                    i = e.i,
                    o = e.j,
                    s = e.x,
                    h = e.y,
    ...
    var Jc = Date.prototype
      ...
      , el = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"]
      , rl = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"];
    ...
    ji.iso = Date.prototype.toISOString && +new Date("2000-01-01T00:00:00.000Z") ? lo : yl,
    lo.parse = function(n) {
        var t = new Date(n);
        return isNaN(t) ? null : t
    }
    ,
    lo.toString = yl.toString,
    ...
    var Ml = [1e3, 5e3, 15e3, 3e4, 6e4, 3e5, 9e5, 18e5, 36e5, 108e5, 216e5, 432e5, 864e5, 1728e5, 6048e5, 2592e6, 7776e6, 31536e6]
      , xl = [[Bc.second, 1], [Bc.second, 5], [Bc.second, 15], [Bc.second, 30], [Bc.minute, 1], [Bc.minute, 5], [Bc.minute, 15], [Bc.minute, 30], [Bc.hour, 1], [Bc.hour, 3], [Bc.hour, 6], [Bc.hour, 12], [Bc.day, 1], [Bc.day, 2], [Bc.week, 1], [Bc.month, 1], [Bc.month, 3], [Bc.year, 1]]
      , bl = [[ji("%Y"), Vt], [ji("%B"), function(n) {
        return n.getMonth()
    }
    ], [ji("%b %d"), function(n) {
        return 1 != n.getDate()
